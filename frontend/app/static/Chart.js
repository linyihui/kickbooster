...
(function(){
	...
	Chart.defaults = {
		global: {
			...
			animationEasing: "easeOut", //"easeOutQuart",
			...
			scaleFontFamily: "'Helvetica Neue', 'Helvetica', 'Arial', 'Lato', sans-serif",
        ...
        this.chart.ctx.font = 'Normal 36px Helvetica Neue';
        this.chart.ctx.fillStyle = '#BABABA';
